...
//
//public class MediaTrackerWatchService implements MediaTrackerService {
//
//    public static final Logger LOG = LoggerFactory.getLogger(MediaTrackerWatchService.class);
//
...
//
//    public MediaTrackerWatchService(MediaTrackerDao dao, CleanerService cs) {
//        mediaTrackerDao = dao;
//        cleanerService = cs;
//    }
//
...
//
//    @Override
//    public void watch(List<Path> paths) throws IOException, InterruptedException {
//        WatchService watchService = FileSystems.getDefault().newWatchService();
//        runWatchService(watchService, paths);
//    }
//
//    private void runWatchService(WatchService watchService, List<Path> paths) throws IOException, InterruptedException {
//        /*
...
//        MediaIgnored mediaIgnored = mediaTrackerDao.findMediaIgnoredByTargetPath(filePath);
...
//    }
//
//    void removeQueryByPath(String path) {
//        List<MediaQuery> queriesByPath = mediaTrackerDao.findInFilePathQuery(path);
//        if (queriesByPath.size() == 0) {
//            LOG.error("[ remove_query ] No queries found, path: {}", path);
//        }
//        for (MediaQuery mq : queriesByPath) {
